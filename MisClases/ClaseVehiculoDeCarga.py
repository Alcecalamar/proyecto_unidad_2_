class VehiculoDeCarga:
    ...
    def __repr__(self):
        return f"VehiculoDeCarga (numero_de_vehiculo={self.get_numero_de_vehiculo()}, tipo={self.get_tipo()}, placas={self.get_placas()}, capmax={self.get_capmax()}, peso_del_producto=´{self.get_peso_del_producto()}, peso_tara={self.get_peso_tara()})"
